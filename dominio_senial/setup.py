...
if README_PATH.exists():
    ...
    README = "Paquete de entidades del dominio para procesamiento de señales digitales"

setup(
    name="dominio-senial",
    version="5.0.0",
    description="Factory Pattern para entidades del dominio con LSP + Configuración Externa",
    ...
    keywords="solid principles, domain entities, signal processing, education",
    project_urls={
